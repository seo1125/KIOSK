        ...
        int num_count =0;
           ...
           String[] b_id_name        = new String[N_ARY];
            ...
            try {
                ...
                int i_cnt=0;
                while(rs.next()) {                        //asd
                    p[i_cnt] = new ProductBuy();        //asd
                   
                    p[i_cnt].cnt = i_cnt+1;                //asd
                        ...
                        if(in_i == 0 || in_i == 9) {
                            ...
                            for(int i=0; i<b_id.length; i++) {
                                if(b_id[i] !=0) {
                                    ...
                                    pstmt = conn.prepareStatement(sql);
                                    pstmt.setInt(1, num_count);                    //주문번호            //asd
                                    pstmt.setInt(2, i+1);                        //주문리스트            //asd
